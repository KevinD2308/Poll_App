...
var app = (function (autosize) {
    ...
    // (59:8) {#each poll.answers as anwr}
    function create_each_block$2(ctx) {
    	...
    	function textarea_input_handler_1() {
    		/*textarea_input_handler_1*/ ctx[5].call(textarea, /*each_value*/ ctx[7], /*anwr_index*/ ctx[8]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "class", "svelte-13ancr5");
    			add_location(textarea, file$3, 59, 12, 1982);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, textarea, anchor);
    			set_input_value(textarea, /*anwr*/ ctx[6]);

    			if (!mounted) {
    				dispose = [
    					listen_dev(textarea, "input", textarea_input_handler_1),
    					listen_dev(textarea, "keydown", /*keyControl*/ ctx[3], false, false, false),
    					action_destroyer(autosize__default["default"].call(null, textarea))
    				];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(59:8) {#each poll.answers as anwr}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 50, 8, 1679);
    			attr_dev(textarea, "rows", "3");
    			textarea.required = true;
    			attr_dev(textarea, "class", "svelte-13ancr5");
    			add_location(textarea, file$3, 51, 8, 1722);
    			attr_dev(div1, "class", "label");
    			add_location(div1, file$3, 57, 8, 1898);
    			attr_dev(button0, "class", "svelte-13ancr5");
    			add_location(button0, file$3, 67, 12, 2218);
    			attr_dev(button1, "class", "svelte-13ancr5");
    			add_location(button1, file$3, 68, 12, 2273);
    			attr_dev(div2, "id", "buttons");
    			attr_dev(div2, "class", "svelte-13ancr5");
    			add_location(div2, file$3, 66, 8, 2186);
    			add_location(form, file$3, 49, 4, 1663);
    			add_location(main, file$3, 47, 0, 1649);
    		},
    		l: function claim(nodes) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function textarea_input_handler_1(each_value, anwr_index) {
    		each_value[anwr_index] = this.value;
    		$$invalidate(0, poll);
    	}
    	...
    	$$self.$capture_state = () => ({
    		onMount,
    		tick,
    		autosize: autosize__default["default"],
    		poll,
    		addAnswer,
    		removeAnswer,
    		keyControl
    ...
    function create_catch_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t = text(t_value);
    			add_location(h1, file$2, 49, 8, 1813);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_then_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div = element("div");
    			div.textContent = "Click answer to vote";
    			t3 = space();
    			...
    			each_1_anchor = empty();
    			add_location(h1, file$2, 43, 8, 1574);
    			attr_dev(div, "class", "label");
    			add_location(div, file$2, 44, 8, 1608);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			append_dev(h1, t0);
    ...
    // (46:8) {#each poll.answers as anwr}
    function create_each_block$1(ctx) {
    	let button;
    	let t_value = /*anwr*/ ctx[5].answer + "";
    	let t;
    	let mounted;
    	let dispose;

    	function click_handler() {
    		return /*click_handler*/ ctx[3](/*anwr*/ ctx[5]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			add_location(button, file$2, 46, 12, 1705);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(46:8) {#each poll.answers as anwr}",
    		ctx
    	});
    ...
    function create_pending_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 41, 8, 1527);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(41:24)           <h1>Loading...</h1>      {:then poll}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			info.block.c();
    			add_location(main, file$2, 39, 0, 1485);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const click_handler = anwr => vote(anwr.id);
    ...
    function create_catch_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t = text(t_value);
    			add_location(h1, file$1, 44, 8, 1432);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			append_dev(h1, t);
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(h1, file$1, 34, 8, 1030);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			append_dev(h1, t0);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "bar zero svelte-1gb0ii7");
    			set_style(div, "width", /*anwr*/ ctx[3].percent + "%");
    			add_location(div, file$1, 40, 16, 1297);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "bar svelte-1gb0ii7");
    			set_style(div, "width", /*anwr*/ ctx[3].percent + "%");
    			add_location(div, file$1, 38, 16, 1194);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    // (36:8) {#each poll.answers as anwr}
    function create_each_block(ctx) {
    	let div;
    	let t0_value = /*anwr*/ ctx[3].answer + "";
    	let t0;
    	let t1;
    	let if_block_anchor;

    	function select_block_type(ctx, dirty) {
    		if (/*anwr*/ ctx[3].percent) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			if_block_anchor = empty();
    			attr_dev(div, "class", "label");
    			add_location(div, file$1, 36, 12, 1106);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(36:8) {#each poll.answers as anwr}",
    		ctx
    	});
    ...
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Loading...";
    			add_location(h1, file$1, 32, 8, 983);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(32:24)           <h1>Loading...</h1>      {:then poll}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			info.block.c();
    			add_location(main, file$1, 30, 0, 941);
    		},
    		l: function claim(nodes) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 13, 0, 322);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
